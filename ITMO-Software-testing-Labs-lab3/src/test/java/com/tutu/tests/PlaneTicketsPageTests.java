...
public class PlaneTicketsPageTests {
    ...
    void mainPageSearchTest() throws InterruptedException {
        ...
        planeTicketsPage.inputText("Москва", planeTicketsPage.getArrivalCity());

        Thread.sleep(1000);

        planeTicketsPage.inputText("Санкт-Петербург", planeTicketsPage.getDepartureCity());
        Thread.sleep(1000);

        planeTicketsPage.inputText("22.05.2021, сб", planeTicketsPage.getDepartureDate());
        Thread.sleep(1000);

        planeTicketsPage.inputText("25.05.2021, вт", planeTicketsPage.getArrivalDate());
        Thread.sleep(1000);
