...
import com.tutu.pages.RegistrationPage;
...
//    @DisplayName("Check if search works correctly")
    ...
    void mainPageSearchTest() throws InterruptedException {
        ...
        WebElement foundElement =
                wait.until(presenceOfElementLocated(By.xpath("/html/body/div[3]/div[1]/div[1]/div[1]/div[2]/div[6]/div/div/div/div[1]/div/div/a")));
        foundElement.click();

        Thread.sleep(10000);

        registrationPage.inputEmail("Max.Lebedev@yandex.ru");

        Thread.sleep(10000);

        registrationPage.click(registrationPage.getCheckboxApproval());

        Thread.sleep(10000);

        registrationPage.click(registrationPage.getRegistrationButton());}
